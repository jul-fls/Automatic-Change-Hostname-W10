...
$Sainte_Famille_Saintonge_Automatic_Hostname_Changer.icon  = New-Object System.Drawing.Icon ("$PSScriptRoot\change-hostname.ico")
...
$numerosalle                     = Get-Content -Path $PSScriptRoot\numerosalle.txt
...
$SalleTxtInput.location          = New-Object System.Drawing.Point(190,195)
...
$pcnumberstr                     = Get-Content -Path $PSScriptRoot\counter.txt
...
$ActualPcNumberTxtInput.location  = New-Object System.Drawing.Point(190,245)
...
$SubmitChanges.Add_Click({
    Set-Content -Path $PSScriptRoot\counter.txt -Value $ActualPcNumberTxtInput.Text
...
$ChangeHostnameNow.Add_Click({
    ...
    $pcnumberint++
    Set-Content -Path $PSScriptRoot\counter.txt -Value $pcnumberint
    $wshell = New-Object -ComObject Wscript.Shell -InformationAction Stop
